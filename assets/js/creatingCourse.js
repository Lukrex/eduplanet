...
next.onclick = ()=>{
    if (s1.style.display === "block") {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s2.classList.remove("slide-left") } , 250);
        }, "250");
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s3.classList.remove("slide-left") } , 250);
        }, "250");
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s4.classList.remove("slide-left") } , 250);
        } , "250");
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s5.classList.remove("slide-left") } , 250);
        } , "250");
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s6.classList.remove("slide-left") } , 250);
        } , "250");
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s7.classList.remove("slide-left") } , 250);
        } , "250");
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s8.classList.remove("slide-left") } , 250);
        } , "250");
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s9.classList.remove("slide-left") } , 250);
        } , "250");
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s10.classList.remove("slide-left") } , 250);
        } , "250");
...
back.onclick = ()=>{
    if (s2.style.display === "block") {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s1.classList.remove("slide-right") } , 250);
        }, "250");
    } else if (s3.style.display === "block") {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s2.classList.remove("slide-right") } , 250);
        }, "250");
    } else if (s4.style.display === "block") {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s3.classList.remove("slide-right") } , 250);
        } , "250");
    } else if (s5.style.display === "block") {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s4.classList.remove("slide-right") } , 250);
        } , "250");
    } else if (s6.style.display === "block") {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s5.classList.remove("slide-right") } , 250);
        } , "250");
    } else if (s7.style.display === "block") {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s6.classList.remove("slide-right") } , 250);
        } , "250");
    } else if (s8.style.display === "block") {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s7.classList.remove("slide-right") } , 250);
        } , "250");
    } else if (s9.style.display === "block") {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s8.classList.remove("slide-right") } , 250);
        } , "250");
    } else if (s10.style.display === "block") {
        next.innerHTML = "Next";
        ...
        setTimeout(() => {
            ...
            setTimeout(() => { s9.classList.remove("slide-right") } , 250);
        } , "250");
    }
}
