...
<?php } ?>
                        ...
                        <div class="form-group mb-3"><label class="form-label text-secondary">Password</label><input class="form-control" type="password" name="password" required="" minlength="8"></div><button class="btn btn-info mt-2" type="submit">Log In</button>
                    </form>
